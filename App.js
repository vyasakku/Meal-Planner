    ...
    if(height && weight && age && gender && activityLevel){
        ...
        try{
            async function runApis(){
                const allMeals = await fetch(`https://api.spoonacular.com/mealplanner/generate?apiKey=b6907688a223401a80350db996fef305&timeFrame=day&targetCalories=${bmr}`);
                ...
                mealsObj.meals.forEach((eachMeal)=>{
                    ...
                    fetch(`https://api.spoonacular.com/recipes/${eachMeal.id}/information?apiKey=b6907688a223401a80350db996fef305`)
                    .then((rel)=> rel.json())
                    .then((recipeObj)=>{
